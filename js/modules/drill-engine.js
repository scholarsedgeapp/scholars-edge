...
const DrillEngineModule = (() => {
  ...
  const DE_QUESTIONS = {
    ...
    M6:[
      ...
      { p:null, q:"A tank fills at 3 liters per minute and drains at 1 liter per minute. How long (in minutes) to fill 20 liters?", c:["20 ÷ 3 = 6.67 minutes","20 ÷ (3-1) = 20 ÷ 2 = 10 minutes","20 ÷ 1 = 20 minutes","20 × 3 = 60 minutes"], a:1, e:"Net rate = fill rate - drain rate = 3 - 1 = 2 L/min. Time = 20 L ÷ 2 L/min = 10 minutes. Unit tracking: L ÷ (L/min) = min ✓." , trap_type:null},
    ],
    M7:[
