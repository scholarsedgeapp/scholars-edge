...
const App = (() => {
  ...
  // ── 8. INIT ── //
  function init() {
    // Request persistent storage — exempts this origin from WebKit's 7-day
    // script-writable-storage eviction (all progress lives in localStorage).
    // Browsers grant/deny silently based on engagement; denial is harmless,
    // so fire-and-forget.
